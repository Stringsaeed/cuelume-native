...
/**
 * `@react-native-masked-view/masked-view`'s bundled types declare the
 * component via a `Constructor<T> & typeof MaskedViewComponent` mixin that
 * React 19's JSX typing rejects ("does not support attributes"/"cannot be
 * used as a JSX component") — a known incompatibility, not a real runtime
 * issue. Re-typed once here rather than suppressing the error at every call site.
 */
const MaskedView = MaskedViewNative as unknown as React.ComponentType<{
